    ...
    return {
        ...
        execute: function() {
            UtilityService = (function () {
                ...
                UtilityService.prototype.setContentHeight = function (contentDOM) {
                    var headerHeight = jQuery("header").height(), footerHeight = jQuery("footer").height(), windowHeight = jQuery(window).height();
